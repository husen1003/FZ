...
<div class="bt" style="background-color:black;">
  ...
  <button type="submit" name="login" class="sactive btn" style="width: 16%;" onclick="window.location.href='south.php'">South Indian</button>
...
<?php
	...
	$result = mysqli_query($con,"SELECT * FROM dishes WHERE dish_catagory = 'South_Indian' ");echo "<br>";
