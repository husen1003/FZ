...
<div class="bt" style="background-color:black;">
  ...
  <button type="submit" name="login" class="sactive btn" style=" width: 10%;" onclick="window.location.href='chinese.php'">Chinese</button>
...
<?php
  ...
  $result = mysqli_query($con,"SELECT * FROM dishes WHERE dish_catagory = 'Chinese' ");echo "<br>";
