...
<div class="bt" style="background-color:black;">
  ...
  <button type="submit" name="login" class="btn1 btn" style="width:10%;" onclick="window.location.href='gujarati.php'">Gujarati</button>
  <button type="submit" name="login" class="btn1 btn" style="width: 16%;" onclick="window.location.href='south.php'">South Indian</button>
  <button type="submit" name="login" class="btn1 btn" style=" width: 10%;" onclick="window.location.href='chinese.php'">Chinese</button>
  <button type="submit" name="login" class="sactive btn" style=" width: 13%;" onclick="window.location.href='fastfood.php'">Fast Food</button>
</div>
...
<?php
	...
	$result = mysqli_query($con,"SELECT * FROM dishes WHERE dish_catagory = 'Fast_food' ");echo "<br>";
