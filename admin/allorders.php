...
<body>
  ...
  ?>
	...
	<br><br>
	<h1 align="center">Orders from users</h1><br>
...
<?php
	$result = mysqli_query($con,"SELECT * FROM dishorder WHERE status = ('delivered') ORDER BY id DESC");echo "<br>";
	while($row = mysqli_fetch_array($result))
	{
?>	


	<tr onclick="document.location = 'delivered_details.php?id=<?php echo $row['id'] ?>';" onmouseover="style='cursor: pointer';">
